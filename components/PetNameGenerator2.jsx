...
<br />
  ...
  {generatedNames.length > 0 && (
        <div className="mt-6">
         ...
         <div className="relative"><button data-copy-to-clipboard-target="npm-install-copy-text" onClick={() => handleCopy(name)}
                >
                  {copiedName === name ? "Copied!" : "Copy"} className="absolute end-2.5 top-1/2 -translate-y-1/2 text-gray-900 dark:text-gray-400 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-700 rounded-lg py-2 px-2.5 inline-flex items-center justify-center bg-white border-gray-200 border">
