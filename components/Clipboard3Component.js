// Clipboard3Component.js
import React, { useState } from "react";

export default function Clipboard3Component({ textToCopy }) {
  ...
  return (
          ...
          <div>
            ...
            <button
              ...
              className="absolute right-3 top-1/2 inline-flex h-8 -translate-y-1/2 items-center justify-center gap-1 rounded-md bg-dark px-2.5 py-1.5 text-sm font-medium text-white duration-200 hover:bg-dark/90"
            >
              <span>
                {copySuccess ? (
                  <svg
